       PROGRAM TESTW3MC
C
C MAIN PROGRAM: TESTW3MC     WRITE AN INDEX FILE
C   PRGMMR: BOI VUONG        DATE: 2021-01-14
C
...
C
C INPUT FILE:
C   gribfile     GRIB1 FILE
C
C OUTPUT FILE:
C   indexfile    GRIB1 INDEX FILE
C
C EXIT STATES:
...
C
     ...
     &          CGRIB*40,CIS*8,CPDS*28,CTITLE*86
      ...
      INTEGER DUM,JGDS(200),MPDST(200),JREW,LENHEAD,MI,ITOT
